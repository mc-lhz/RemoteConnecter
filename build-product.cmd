...
echo 构建中...
.\python39\python.exe -m PyInstaller -F --noconfirm --hide-console hide-early --upx-dir "upx" --hidden-import functions.bilimusic.bilimusic_bp --hidden-import functions.main.main_bp --hidden-import functions.main.file_bp --hidden-import functions.screen.screen_bp --hidden-import functions.term.term_bp --hidden-import functions.update.update_bp --hidden-import functions.shared --add-data "functions\main\templates;functions/main/templates" --add-data "functions\main\static;functions/main/static" --add-data "functions\screen\templates;functions/screen/templates" --add-data "functions\screen\static;functions/screen/static" --add-data "functions\term\templates;functions/term/templates" --add-data "functions\term\static;functions/term/static" --add-data "functions\bilimusic\templates;functions/bilimusic/templates" --add-data "functions\bilimusic\static;functions/bilimusic/static" --add-data "functions\update\templates;functions/update/templates" --add-data "functions\update\static;functions/update/static" --add-data "functions\shared\static;functions/shared/static" --add-binary "bin\ffmpeg.exe;." --collect-all winpty RemoteConnecter.py
